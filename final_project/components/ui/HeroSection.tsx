  ...
  return (
    <section className={`${montserrat.variable} min-h-screen text-white flex flex-col justify-center items-center px-4`}>
      <div className="text-center space-y-7 max-w-3xl mx-auto -mt-12">
        ...
        <h1 className={`${poppins.className} text-6xl md:text-8xl bg-gradient-to-r from-green-400 via-cyan-200 to-blue-400 text-transparent bg-clip-text animate-in mx-auto`}>
        ...
        <div className="flex items-center justify-center gap-8 mt-20">
          <Button className="bg-blue-800 px-4 py-5 w-35 hover:bg-blue-500 font-semibold">
            Explore
          </Button>
          <Button className="bg-white text-black px-4 py-5 w-35 hover:bg-gray-400 font-semibold">
            Get Started
          </Button>
        </div>
      </div>
